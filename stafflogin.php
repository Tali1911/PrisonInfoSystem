...
move_uploaded_file($_FILES["avatar"]["tmp_name"],"../admin/uploadImage/Profile/" . $_FILES["avatar"]["name"]);
$location="../admin/uploadImage/Profile/" . $_FILES["avatar"]["name"];
}
