...
<main>
    ...
    <div class="table-data">
        <di class="order">
            <div class="head">
                <h3>List of Prisons</h3>
                <span><i class='bx bx-search'></i></span>
                <span><i class='bx bx-filter'></i></span>
                <a href="addprison.php" class="btn-download">
                    <span class="icon"><i class='bx bxs-cloud-download'></i></span>
                    <span class="text">+ Add prison</span>
                </a>
            </div>
            <table>
                <thead>
                        ...
                        <tr>
                            ...
                            <div class="dropdown">
                                        ...
                                        <div class="dropdown-content">                                       
                                            ...
                                            <a href="edit_prison.php?id=<?php echo $row['id']; ?>">Edit</a>
                                            <div class="dropdown-divider"></div>
                                            <a href="delete_prison.php?id=<?php echo $row['id']; ?>" onClick="return deldata('<?php echo $row['name']; ?>');">Delete</a>
                                        </div>
                                    </div>
                            </td>               
                        </tr>                                
